...
class appProdProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\ReconBundle/Resources/views'), 'Recon');
        $instance->addPath(($this->targetDirs[3].'\\src\\ReconBundle/Resources/views'), '!Recon');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ReconBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ReconBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ReconBundle' => 'ReconBundle\\ReconBundle',
            ),
            ...
            'database_port' => NULL,
            'database_name' => 'reconv',
            'database_user' => 'root',
            'database_password' => 'mysql',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'auth.smtp.1and1.fr',
            'mailer_user' => 'reconv@santhor.com',
            'mailer_password' => 'Reconversion2018.',
            'mailer_port' => 587,
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'reconv@santhor.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Reconversion2018.',
            ...
            'fos_user.model.user.class' => 'ReconBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'toto@upmc.com' => 'toto BundleFOSUser',
            ),
